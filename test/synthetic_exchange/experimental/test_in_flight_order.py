...
from synthetic_exchange.experimental.dtype import PositionAction, OrderType
from synthetic_exchange.experimental.in_flight_order import InFlightOrder, OrderState, OrderUpdate, TradeUpdate
from synthetic_exchange.experimental.limit_order import LimitOrder
from synthetic_exchange.experimental.trade_fee import AddedToCostTradeFee, TokenAmount


class InFlightOrderTest(unittest.TestCase):
	@classmethod
	...
	@patch("synthetic_exchange.experimental.in_flight_order.GET_EX_ORDER_ID_TIMEOUT", 0.1)
	...
	def test_from_json_does_not_fail_when_order_fills_not_present(self):
		order_json = {
			...
			"last_state": "0",
			"leverage": "1",
			"position": PositionAction.PositionAction_Nil.value,
