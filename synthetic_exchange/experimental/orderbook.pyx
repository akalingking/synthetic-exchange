...
# distutils: sources=synthetic_exchange/experimental/OrderBookEntry.cpp
...
from synthetic_exchange.experimental.orderbook_message import OrderBookMessage
from synthetic_exchange.experimental.dtype import OrderBookRow, EventType
from synthetic_exchange.experimental.orderbook_entry cimport truncateOverlapEntries
...
cdef class OrderBook(PubSub):
	...
	ORDER_BOOK_TRADE_EVENT_TAG = EventType.EventType_Trade.value
	...
	def apply_trade(self, trade: Event):
